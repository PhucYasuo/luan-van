...
DROP TABLE IF EXISTS chitietnghiphep;
DROP TABLE IF EXISTS phieunghiphep;
DROP TABLE IF EXISTS trangthai;
DROP TABLE IF EXISTS congtacgiangday;
...
CREATE TABLE thoikhoabieu (
  ...
  NH_NamHoc char(9) NOT NULL,
  HK_HocKy char(1) NOT NULL,
  TKB_Thu varchar(3) NOT NULL,
  TKB_TietBD int NOT NULL,
  TKB_SoTiet int NOT NULL,
  TKB_Lan varchar(2) NOT NULL,
  TKB_NgayHieuLuc date NOT NULL,

  PRIMARY KEY (M_Ma, L_STTLop, K_Khoi, KH_KyHieu, NH_NamHoc, HK_HocKy, TKB_Thu, TKB_Lan),
  FOREIGN KEY (M_Ma) REFERENCES monhoc (M_Ma) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (GV_Ma) REFERENCES giaovien (GV_Ma) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (L_STTLop,K_Khoi,KH_KyHieu,NH_NamHoc) REFERENCES lop (L_STTLop,K_Khoi,KH_KyHieu,NH_NamHoc) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (HK_HocKy) REFERENCES hocky (HK_HocKy) ON DELETE CASCADE ON UPDATE CASCADE
...
('GV003', 'MON01', '2', '11', 'A', '2023-2024', '2', 'Mon', 2, 4, '1', '2024-09-09'),
('GV003', 'MON01', '3', '11', 'A', '2023-2024', '2', 'Tue', 1, 4, '1', '2024-09-09'),
('GV003', 'MON01', '4', '11', 'A', '2023-2024', '2', 'Wed', 1, 4, '1', '2024-09-09'),
('GV003', 'MON01', '1', '11', 'P', '2023-2024', '2', 'Thu', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '2', '11', 'P', '2023-2024', '2', 'Tue', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '1', '12', 'A', '2023-2024', '2', 'Wed', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '2', '12', 'A', '2023-2024', '2', 'Thu', 1, 4, '1', '2024-09-09'),
('GV005', 'MON01', '3', '12', 'A', '2023-2024', '2', 'Tue', 1, 4, '1', '2024-09-09'),
('GV005', 'MON01', '1', '12', 'P', '2023-2024', '2', 'Wed', 1, 4, '1', '2024-09-09'),
...
('GV003', 'MON13', '2', '11', 'A', '2023-2024', '2', 'Fri', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '3', '11', 'A', '2023-2024', '2', 'Tue', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '4', '11', 'A', '2023-2024', '2', 'Wed', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '1', '11', 'P', '2023-2024', '2', 'Thu', 5, 1, '1', '2024-09-09'),
('GV004', 'MON13', '2', '11', 'P', '2023-2024', '2', 'Tue', 5, 1, '1', '2024-09-09'),
('GV004', 'MON13', '1', '12', 'A', '2023-2024', '2', 'Wed', 5, 1, '1', '2024-09-09'),
('GV004', 'MON13', '2', '12', 'A', '2023-2024', '2', 'Thu', 5, 1, '1', '2024-09-09'),
('GV005', 'MON13', '3', '12', 'A', '2023-2024', '2', 'Tue', 5, 1, '1', '2024-09-09'),
('GV005', 'MON13', '1', '12', 'P', '2023-2024', '2', 'Wed', 5, 1, '1', '2024-09-09'),
...
('GV003', 'MON01', '2', '12', 'A', '2024-2025', '1', 'Mon', 2, 4, '1', '2024-09-09'),
('GV003', 'MON01', '3', '12', 'A', '2024-2025', '1', 'Tue', 1, 4, '1', '2024-09-09'),
('GV003', 'MON01', '4', '12', 'A', '2024-2025', '1', 'Wed', 1, 4, '1', '2024-09-09'),
('GV003', 'MON01', '1', '12', 'P', '2024-2025', '1', 'Thu', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '2', '12', 'P', '2024-2025', '1', 'Tue', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '1', '10', 'A', '2024-2025', '1', 'Wed', 1, 4, '1', '2024-09-09'),
('GV004', 'MON01', '2', '10', 'A', '2024-2025', '1', 'Thu', 1, 4, '1', '2024-09-09'),
('GV005', 'MON01', '3', '10', 'A', '2024-2025', '1', 'Tue', 1, 4, '1', '2024-09-09'),
('GV005', 'MON01', '1', '10', 'P', '2024-2025', '1', 'Wed', 1, 4, '1', '2024-09-09'),
...
('GV003', 'MON13', '2', '12', 'A', '2024-2025', '1', 'Fri', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '3', '12', 'A', '2024-2025', '1', 'Tue', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '4', '12', 'A', '2024-2025', '1', 'Wed', 5, 1, '1', '2024-09-09'),
('GV003', 'MON13', '1', '12', 'P', '2024-2025', '1', 'Thu', 5, 1, '1', '2024-09-09'),
('GV004', 'MON13', '2', '12', 'P', '2024-2025', '1', 'Tue', 5, 1, '1', '2024-09-09'),
('GV004', 'MON13', '1', '10', 'A', '2024-2025', '1', 'Wed', 5, 1, '1', '2024-09-09'),
...
CREATE TABLE phieunghiphep (
  ...
  FOREIGN KEY (HK_HocKy) REFERENCES hocky (HK_HocKy) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (NH_NamHoc) REFERENCES namhoc (NH_NamHoc) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (TT_Ma) REFERENCES trangthai (TT_Ma) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB;
...
CREATE TABLE chitietnghiphep (
  ...
  PRIMARY KEY (PNP_STT, CTNP_NgayNghi, L_STTLop, K_Khoi, KH_KyHieu, NH_NamHoc, M_Ma),
